...
model_path = "/mnt/pfs/users/yuzhipeng/dataset/Spaceship/sketchfab/1e267fef67684019b19380a25c81367e.glb"
...
batch = load_or_create_multimodal_batch(
    ...
    mv_light_mode="basic",
    mv_image_size=256,
    cache_dir="example_data/cactus/cached_debug",
...
with torch.no_grad():
    ...
    for idx, image in enumerate(images):
        image.save(f'test_debug/{idx}.png')    
